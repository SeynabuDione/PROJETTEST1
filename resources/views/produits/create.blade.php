...
@section('content')
                ...
                <div class="row g-4 settings-section">
	                <div class="col-12 col-md-4">
		                ...
		                <div class="section-intro">Ajouter un nouveau burger </div>
	                </div>
						    ...
						    <div class="app-card-body">
                                ...
                                action="{{route('produit.store')}}">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        placeholder="Saisir un nom " name="nom" value = "{{old('nom')}}">
                                        @error('nom')
                                    ...
                                    <div class="mb-3">
                                        ...
                                        placeholder=" Saisir une description " name="description" value = "{{old('description')}}">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        placeholder="Saisir un  prix " name="prix" value = "{{old('prix')}}">
                                        @error('prix')
                                        <div class="text-danger"> {{ $message }}</div>
